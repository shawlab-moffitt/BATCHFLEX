...
evaluation_sva <- function(mat,
  ...
  uncorrected_SVA_nsv <- sva::num.sv(mat, uncorrected_mod, method = sva_nsv_method)
  ...
  if(!is.null(batch_correction)){
    ...
    corrected_SVA_nsv <- sva::num.sv(batch_correction, uncorrected_mod, method = sva_nsv_method)
