evaluation_pca = function(mat = NULL,
  ...
  if (annotation == "cluster" & is.null(uncorrected_cluster_number) ){
  ...
  if (annotation == "cluster" & !is.null(batch_correction) & is.null(corrected_cluster_number) ){
  ...
  if (annotation == "meta" & is.null(batch)){
    print("Missing batch information")
  }
  if (annotation == "meta" & is.null(variable_of_interest)){
