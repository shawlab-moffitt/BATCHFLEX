...
#' @param cores A numeric used to set the number of cores used by RLE. If none is chosen, then cores is default to 1 or what is set by the Batch_FLEX parent function.
#'
