...
batch_evaluate = function(mat = NULL,
  ...
  if ("all" %in% evaluation_method) {
    evaluation_method = c("pca", "cluster_analysis", "cluster_HE", "mc_pca", "pca_details", "rle", "ev", "sva", "umap")}
  if (is.null(variable_of_interest)) {
    evaluation_method = evaluation_method[evaluation_method != "sva"]}
  if (!all(evaluation_method %in% c("pca", "cluster_analysis", "cluster_HE", "mc_pca", "pca_details", "rle", "ev", "sva", "umap"))) {
