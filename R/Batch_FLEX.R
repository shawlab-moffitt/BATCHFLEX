...
Batch_FLEX = function(Batch_FLEX_function = c("batch_correct", "batch_evaluate"),
  ...
  if (!all(Batch_FLEX_function %in% c("retrieve_data", "simulate_data", "merge_data", "preprocess_matrix", "batch_correct", "batch_evaluate", "BatchFLEX_export", "BatchFLEX_shiny"))){
