...
test_Batch_FLEX <- Batch_FLEX(mat = example_mat, meta = example_meta, batch.1 = "batchflex_study", variable_of_interest = "Major_Lineage", correction_method = c("Limma", "ComBat", "Mean Centering", "RUVg", "SVA"), parallelize = TRUE)
test_Batch_FLEX[["batch_evaluation"]][["Unadjusted"]]
```
