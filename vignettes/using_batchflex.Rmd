...
example_mat_abbreviated <- example_mat[,1:100]
example_meta_abbreviated <- example_meta[1:100,]
test_Batch_FLEX <- Batch_FLEX(Batch_FLEX_function = c("batch_evaluate", "batch_correct", "BatchFLEX_export"), correction_method = c("ComBat", "Limma"), mat = example_mat_abbreviated, meta = example_meta_abbreviated, batch.1 = "batchflex_study", variable_of_interest = "MajorCellType")
