...
adjusted_data = batch_correction(mat = example_mat,
                                 meta = example_meta,
                                 method = c("Limma", "ComBat", "Mean Centering"),
                                 batch.1 = "Study",
