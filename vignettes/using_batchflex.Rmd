...
test_example$batch_evaluation$Limma$batch1$Plots$umap
```
...
adjusted_data <- batch_correct(mat = BatchFLEX::preprocess_matrix(BatchFLEX::example_mat, quantnorm = FALSE),
                                   ...
                                   batch.1 = "batchflex_study",
                                   variable_of_interest = "MajorCellType")
head(as.data.frame(adjusted_data[["Harman"]]), n = c(5,5))
head(as.data.frame(adjusted_data[["Mean Centering"]]), n = c(5,5))
```
...
head(as.data.frame(test_Batch_FLEX[["data_matrices"]][["Limma"]]), n = c(5,5))
